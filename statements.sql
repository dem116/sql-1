...
-- Tu respuesta aquí
SELECT nombre, edad FROM usuarios_lenguajes  WHERE edad > 30; --para ver la edad también u otra opcion:
SELECT nombre FROM usuarios_lenguajes  WHERE edad > 30; --solo nombre
...
-- Tu respuesta aquí
SELECT nombre FROM usuarios_lenguajes WHERE edad=28; --se puede agregar edad para comprobar que todos en el resultado tienen 28
...
-- Tu respuesta aquí
SELECT lenguaje, COUNT(*) AS cantidad FROM usuarios WHERE edad < 30 GROUP BY lenguaje ORDER BY cantidad DESC LIMIT 1;

-- Ejercicio 15: Seleccionar el usuario  mayor de 25 y que sepa el lenguaje 'TypeScript'.
-- Tu respuesta aquí
SELECT nombre FROM usuarios_lenguajes WHERE lenguaje='TypeScript' AND edad > 25;
...
-- Tu respuesta aquí
SELECT nombre, lenguaje FROM usuarios_lenguajes WHERE edad BETWEEN 25 AND 35 AND lenguaje IS NOT NULL;
...
-- Tu respuesta aquí
SELECT COUNT(DISTINCT lenguaje) AS numlenguajes FROM usuarios_lenguajes WHERE edad > 25;
...
-- Tu respuesta aquí
SELECT COUNT(*) AS u_20a25 FROM usuarios_lenguajes WHERE edad BETWEEN 20 AND 25 AND lenguaje IS NOT NULL;


-- Ejercicio 33: Seleccionar los usuarios que no tienen un lenguaje asociado llamado 'SQL'.
-- Tu respuesta aquí
SELECT nombre, lenguaje FROM usuarios_lenguajes WHERE lenguaje != 'SQL';
...
-- Tu respuesta aquí
SELECT COUNT(*) AS usuarios_script FROM usuarios_lenguajes WHERE lenguaje LIKE '%Script%';



-- Ejercicio 37: Seleccionar los usuarios que tienen al menos un lenguaje asociado y mostrar la longitud de su nombre. 
-- Tu respuesta aquí
SELECT nombre, LENGTH(nombre) AS nombre_longitud FROM usuarios_lenguajes WHERE lenguaje IS NOT NULL;


-- Ejercicio 38: Encontrar el lenguaje del usuario creado más tarde. 
-- Tu respuesta aquí
SELECT lenguaje FROM usuarios_lenguajes ORDER BY fecha_creacion DESC LIMIT 1;


-- Ejercicio 39: Seleccionar los usuarios y mostrar la suma de sus edades. 
-- Tu respuesta aquí
SELECT SUM(edad) AS edad_suma FROM usuarios_lenguajes;

-- Ejercicio 40: Contar cuántos usuarios tienen un lenguaje asociado que comienza con la letra 'P' y tienen menos de 28 años.
-- Tu respuesta aquí
SELECT COUNT(*) AS lenguaje_P FROM usuarios_lenguajes WHERE lenguaje LIKE 'P%' AND edad < 28;
